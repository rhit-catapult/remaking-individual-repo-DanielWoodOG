...
def main():
    ...
    caption_win = font.render("Bullseye!",True, text_color)
    caption_lose = font.render("Missed", True , text_color)
    ...
    while True:
        ...
        # Create a text image (render the text) based on the message_text
        message_image = font.render(message_text, True, (122, 237, 201))

        screen.blit(instructions_image, (25, 25))
        # Draw the message to the user that says 'Bullseye!' or 'You missed!'
